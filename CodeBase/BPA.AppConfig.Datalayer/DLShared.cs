...
namespace BPA.AppConfig.Datalayer
{
    public sealed class DL_Shared
    {
        ...
        {
            return new Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(EncryptDecrypt.Decrypt(oTenant.DatabaseConnectionString));//"Server=VDTC3-APP-ADT18;Trusted_Connection=False;database=DCCSWM_BS; Min Pool Size=10;Max Pool Size=500;MultipleActiveResultSets=True;"
        }
