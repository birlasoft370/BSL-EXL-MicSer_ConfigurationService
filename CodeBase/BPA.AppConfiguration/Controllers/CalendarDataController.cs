...
namespace BPA.AppConfiguration.Controllers
{
    ...
    public class CalendarDataController : BaseController<CalendarDataController>
    {
        ...
        public async Task<MessageResponse<string>> AddCalenderData([FromBody] CalendarDataModel strCalendarDataModel)
        {
            ...
            try
            {
                ...
                {
                    result = "dispCalendarDataExist";// + objCalendarDataModel.CalendarDate + ", Year " + objCalendarDataModel.CalendarDate + " and Week " + objCalendarDataModel.CalendarDate;
                }
                else if (aryDataFlag[0].ToString() == "3")
                {
                    result = "dispDateRangeOverlaps" + aryDataFlag[1].ToString();
                }
        ...
        [NonAction]
        private BECalendarInfo CatchRecord(CalendarDataModel objCalendarDataModel, List<Calendarweek> objCalendarweek)
        {
